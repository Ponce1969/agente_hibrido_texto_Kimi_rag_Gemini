...
class PDFContextManager:
    ...
    def render_pdf_upload(self) -> int | None:
        """
    ...
    def render_existing_pdf_selector(self) -> int | None:
        """
                ...
                with st.container():
                    ...
                    with col3:
                        ...
                        if is_selected:
                            ...
                            if st.button("📌 Seleccionar", key=f"select_{file.id}", use_container_width=True, type="primary"):
    ...
    def render_pdf_section(self) -> tuple[int | None, bool]:
        """
        ...
        with tab2:
            ...
            self.render_existing_pdf_selector()
